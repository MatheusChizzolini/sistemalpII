...
import { buscarFornecedor, excluirFornecedor } from "../../../redux/fornecedorReducer";
...
export default function TabelaFornecedor(props) {
    ...
    function editarFornecedor(fornecedor) {
        ...
        props.setFornecedorSel(fornecedor);
        props.setExibirTabela(false);
    }

    function apagarFornecedor(fornecedor) {
        if (window.confirm("Deseja realmente excluir o forncecedor " + fornecedor.nome)) {
            despachante(excluirFornecedor(fornecedor));
        }
    }
